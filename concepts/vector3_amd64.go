...
//go:generate go run vector3_amd64_asm.go -out vector3_amd64_asm.s -stubs vector3_amd64_stub.go

// Vector3 is a simple 3d vector type.
// For AMD64 assembly, have an empty 4th element to enable fast moves
...
func (v *Vector3) AddSelf(v2 *Vector3) *Vector3 {
	asmVector3AddSelf((*[4]float64)(v), (*[4]float64)(v2))
	return v
}
...
func (v *Vector3) SubSelf(v2 *Vector3) *Vector3 {
	asmVector3SubSelf((*[4]float64)(v), (*[4]float64)(v2))
	return v
}
