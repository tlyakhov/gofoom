...
func (*Spawnee) ComponentID() ecs.ComponentID {
	return SpawneeCID
}
func GetSpawner(e ecs.Entity) *Spawner {
	if asserted, ok := ecs.GetComponent(e, SpawnerCID).(*Spawner); ok {
		return asserted
	}
	return nil
}

func (*Spawner) ComponentID() ecs.ComponentID {
	return SpawnerCID
}
