...
func (ms *MaterialSampler) SampleShader(eShader concepts.Entity, extraStages []*materials.ShaderStage, u, v float64, scale float64) *concepts.Vector4 {
	...
	if shader == nil {
		ms.sampleTexture(&ms.Output, eShader, nil, u, v, scale)
	} else {
...
func (ms *MaterialSampler) sampleTexture(result *concepts.Vector4, material concepts.Entity, stage *materials.ShaderStage, u, v float64, scale float64) *concepts.Vector4 {
