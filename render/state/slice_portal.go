...
func (slice *SlicePortal) CalcScreen() {
	...
	slice.AdjProjHeightTop = slice.ProjectZ(slice.Adj.GetSector().TopZ - slice.CameraZ)
	slice.AdjProjHeightBottom = slice.ProjectZ(slice.Adj.GetSector().BottomZ - slice.CameraZ)
