...
func init() {
	Symbols["tlyakhov/gofoom/components/audio/audio"] = map[string]reflect.Value{
		...
		"SoundPlayInterruptPerTag": reflect.ValueOf(audio.SoundPlayInterruptPerTag),
		"SoundPlayModeString":      reflect.ValueOf(audio.SoundPlayModeString),
		"SoundPlayModeStrings":     reflect.ValueOf(audio.SoundPlayModeStrings),
		"SoundPlayModeValues":      reflect.ValueOf(audio.SoundPlayModeValues),
		"SoundPlayNormal":          reflect.ValueOf(audio.SoundPlayNormal),
		"SoundPlayOnePerTag":       reflect.ValueOf(audio.SoundPlayOnePerTag),
		...
		"SoundPlayMode": reflect.ValueOf((*audio.SoundPlayMode)(nil)),
