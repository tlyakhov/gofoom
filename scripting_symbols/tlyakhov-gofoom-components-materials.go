...
func init() {
	Symbols["tlyakhov/gofoom/components/materials/materials"] = map[string]reflect.Value{
		...
		"ScaleAll":                  reflect.ValueOf(materials.ScaleAll),
		...
		"SurfaceScaleString":        reflect.ValueOf(materials.SurfaceScaleString),
		"SurfaceScaleStrings":       reflect.ValueOf(materials.SurfaceScaleStrings),
		"SurfaceScaleValues":        reflect.ValueOf(materials.SurfaceScaleValues),
		...
		"SurfaceScale": reflect.ValueOf((*materials.SurfaceScale)(nil)),
