...
func init() {
	Symbols["tlyakhov/gofoom/components/behaviors/behaviors"] = map[string]reflect.Value{
		...
		"InventoryItemAutoPlayerTargetable": reflect.ValueOf(behaviors.InventoryItemAutoPlayerTargetable),
		"InventoryItemAutoProximity":        reflect.ValueOf(behaviors.InventoryItemAutoProximity),
		"InventoryItemBounce":               reflect.ValueOf(behaviors.InventoryItemBounce),
		"InventoryItemCID":                  reflect.ValueOf(&behaviors.InventoryItemCID).Elem(),
		"InventoryItemFlagsString":          reflect.ValueOf(behaviors.InventoryItemFlagsString),
		"InventoryItemFlagsStrings":         reflect.ValueOf(behaviors.InventoryItemFlagsStrings),
		"InventoryItemFlagsValues":          reflect.ValueOf(behaviors.InventoryItemFlagsValues),
		...
		"InventoryItemFlags":  reflect.ValueOf((*behaviors.InventoryItemFlags)(nil)),
