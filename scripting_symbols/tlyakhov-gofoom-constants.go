...
func init() {
	Symbols["tlyakhov/gofoom/constants/constants"] = map[string]reflect.Value{
		...
		"LightGrid":                reflect.ValueOf(constant.MakeFromLiteral("5", token.FLOAT, 0)),
		"LightSafety":              reflect.ValueOf(constant.MakeFromLiteral("2", token.INT, 0)),
		"LightmapRefreshDither":    reflect.ValueOf(constant.MakeFromLiteral("8", token.INT, 0)),
		...
		"MaxLightmapAge":           reflect.ValueOf(constant.MakeFromLiteral("4", token.INT, 0)),
		"MaxPortals":               reflect.ValueOf(constant.MakeFromLiteral("100", token.INT, 0)),
		"MaxViewDistance":          reflect.ValueOf(constant.MakeFromLiteral("1000000", token.FLOAT, 0)),
		"MetersPerUnit":            reflect.ValueOf(constant.MakeFromLiteral("0.03125", token.FLOAT, 0)),
		"MinMillisPerFrame":        reflect.ValueOf(constant.MakeFromLiteral("66.666666666666666664353702032030923874117434024810791015625", token.FLOAT, 0)),
		...
		"PlayerSwimStrength":       reflect.ValueOf(constant.MakeFromLiteral("0.004999999999999999999898356046329483959311801299918442964553833008", token.FLOAT, 0)),
		"PlayerTurnSpeed":          reflect.ValueOf(constant.MakeFromLiteral("180", token.FLOAT, 0)),
		"PlayerWalkForce":          reflect.ValueOf(constant.MakeFromLiteral("6666.666666666666666518636930049979127943515777587890625", token.FLOAT, 0)),
		...
		"SwimDamping":              reflect.ValueOf(constant.MakeFromLiteral("2", token.FLOAT, 0)),
		"TimeStep":                 reflect.ValueOf(constant.MakeFromLiteral("8.333333333333333333044212754003865484264679253101348876953125", token.FLOAT, 0)),
		"TimeStepS":                reflect.ValueOf(constant.MakeFromLiteral("0.008333333333333333333728615375385340158231883833650499582290649414", token.FLOAT, 0)),
