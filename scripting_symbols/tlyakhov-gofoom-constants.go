...
func init() {
	Symbols["tlyakhov/gofoom/constants/constants"] = map[string]reflect.Value{
		...
		"DefaultFontPath":            reflect.ValueOf(constant.MakeFromLiteral("\"../gofoom-data/fonts/vga-font-8x8.png\"", token.STRING, 0)),
		...
		"IntersectEpsilon":           reflect.ValueOf(constant.MakeFromLiteral("1.000000000000000000000707446218885976918933772283892835730512161e-08", token.FLOAT, 0)),
		"LightAttenuationEpsilon":    reflect.ValueOf(constant.MakeFromLiteral("0.1000000000000000000013552527156068805425093160010874271392822266", token.FLOAT, 0)),
		...
		"PursuitBreadcrumbRateNs":    reflect.ValueOf(constant.MakeFromLiteral("250000000", token.INT, 0)),
		"PursuitEnemyTargetDistance": reflect.ValueOf(constant.MakeFromLiteral("1000", token.FLOAT, 0)),
		"PursuitMaxBreadcrumbs":      reflect.ValueOf(constant.MakeFromLiteral("20", token.INT, 0)),
		"PursuitNpcAvoidDistance":    reflect.ValueOf(constant.MakeFromLiteral("50", token.FLOAT, 0)),
		"PursuitWallAvoidDistance":   reflect.ValueOf(constant.MakeFromLiteral("50", token.FLOAT, 0)),
		...
		"TestWorldPath":              reflect.ValueOf(constant.MakeFromLiteral("\"../gofoom-data/worlds/pursuer-test.yaml\"", token.STRING, 0)),
		"TimeStepMS":                 reflect.ValueOf(constant.MakeFromLiteral("7.8125", token.FLOAT, 0)),
		"TimeStepNS":                 reflect.ValueOf(constant.MakeFromLiteral("7812500", token.FLOAT, 0)),
