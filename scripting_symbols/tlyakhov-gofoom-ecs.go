...
func init() {
	Symbols["tlyakhov/gofoom/ecs/ecs"] = map[string]reflect.Value{
		...
		"ComponentLockedEntityInEditor":   reflect.ValueOf(ecs.ComponentLockedEntityInEditor),
		...
		"EntityRegexpIdxFileHash":         reflect.ValueOf(constant.MakeFromLiteral("3", token.INT, 0)),
		...
		"FieldFlagsFromTag":               reflect.ValueOf(ecs.FieldFlagsFromTag),
		"FieldFlagsString":                reflect.ValueOf(ecs.FieldFlagsString),
		"FieldFlagsStrings":               reflect.ValueOf(ecs.FieldFlagsStrings),
		"FieldFlagsValues":                reflect.ValueOf(ecs.FieldFlagsValues),
		"FieldNonCacheable":               reflect.ValueOf(ecs.FieldNonCacheable),
		"FieldNonTraversable":             reflect.ValueOf(ecs.FieldNonTraversable),
		"FieldShallowCacheable":           reflect.ValueOf(ecs.FieldShallowCacheable),
		"FindReplaceRelations":            reflect.ValueOf(ecs.FindReplaceRelations),
		...
		"ModifyEntityRelationEntities":    reflect.ValueOf(ecs.ModifyEntityRelationEntities),
		"MoveEntityComponents":            reflect.ValueOf(ecs.MoveEntityComponents),
		...
		"RelationMap":                     reflect.ValueOf(ecs.RelationMap),
