...
func init() {
	Symbols["tlyakhov/gofoom/components/core/core"] = map[string]reflect.Value{
		...
		"ActionWaypointCID":              reflect.ValueOf(&core.ActionWaypointCID).Elem(),
		...
		"GetActionWaypoint":              reflect.ValueOf(core.GetActionWaypoint),
		...
		"SelectableActionWaypoint":       reflect.ValueOf(core.SelectableActionWaypoint),
		...
		"SelectableFromActionWaypoint":   reflect.ValueOf(core.SelectableFromActionWaypoint),
		...
		// type definitions
		"ActionWaypoint":    reflect.ValueOf((*core.ActionWaypoint)(nil)),
