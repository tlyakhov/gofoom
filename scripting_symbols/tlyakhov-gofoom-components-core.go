...
func init() {
	Symbols["tlyakhov/gofoom/components/core/core"] = map[string]reflect.Value{
		...
		"MaterialScaleStrings":     reflect.ValueOf(core.MaterialScaleStrings),
		"MaterialScaleValues":      reflect.ValueOf(core.MaterialScaleValues),
		"Remove":                   reflect.ValueOf(core.Remove),
		"ScaleAll":                 reflect.ValueOf(core.ScaleAll),
		"ScaleHeight":              reflect.ValueOf(core.ScaleHeight),
		"ScaleNone":                reflect.ValueOf(core.ScaleNone),
		"ScaleWidth":               reflect.ValueOf(core.ScaleWidth),
		...
		"MaterialScale":     reflect.ValueOf((*core.MaterialScale)(nil)),
