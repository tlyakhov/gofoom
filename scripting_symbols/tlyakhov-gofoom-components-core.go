...
func init() {
	Symbols["tlyakhov/gofoom/components/core/core"] = map[string]reflect.Value{
		...
		"GetPath":                        reflect.ValueOf(core.GetPath),
		...
		"PathComponentIndex":             reflect.ValueOf(&core.PathComponentIndex).Elem(),
		...
		"SelectableFromPath":             reflect.ValueOf(core.SelectableFromPath),
		"SelectableFromPathSegment":      reflect.ValueOf(core.SelectableFromPathSegment),
		...
		"SelectablePath":                 reflect.ValueOf(core.SelectablePath),
		"SelectablePathSegment":          reflect.ValueOf(core.SelectablePathSegment),
		...
		"Path":              reflect.ValueOf((*core.Path)(nil)),
		"PathSegment":       reflect.ValueOf((*core.PathSegment)(nil)),
