...
//go:generate fyne bundle --pkg resources -o bundled.go icon-add-entity.svg
var ResourceIconAddEntity = theme.NewThemedResource(resourceIconAddEntitySvg)

//go:generate fyne bundle -o bundled.go -append icon-add-sector.svg
var ResourceIconAddSector = theme.NewThemedResource(resourceIconAddSectorSvg)

//go:generate fyne bundle -o bundled.go -append icon-split-sector.svg
var ResourceIconSplitSector = theme.NewThemedResource(resourceIconSplitSectorSvg)

//go:generate fyne bundle -o bundled.go -append icon-split-segment.svg
